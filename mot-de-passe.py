...
L1 = tkinter.Label(window,text="Saisir votre Nom :",bg="purple")
L1.place(x=20,y=30)
Z1 = tkinter.Entry()
Z1.place(x=180,y=30)
L2 = tkinter.Label(window,text="Saisir votre Telephone :",bg="purple")
L2.place(x=20,y=75)
Z2 = tkinter.Entry()
Z2.place(x=180,y=75)
L3 = tkinter.Label(window,text="Saisir votre Email :",bg="purple")
L3.place(x=20,y=120)
Z3 = tkinter.Entry()
...
but1 = tkinter.Button(window,text="Effacer",command=clear)
but1.place(x=230,y=160)
but2 = tkinter.Button(window,text="Valider",command=validate)
